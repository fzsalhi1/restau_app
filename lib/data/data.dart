...
import 'package:restau_app/models/user.dart';
...
final _restaurant1 = Restaurant(
  ...
  address: '200 Main St, New York, NY',
  rating: 4,
  menu: [_steak, _pasta, _ramen, _pancakes, _burger, _pizza, _salmon],
);
...
final _restaurant2 = Restaurant(
  ...
  address: '200 Main St, New York, NY',
  rating: 4,
  menu: [_steak, _pasta, _pancakes, _burger, _pizza],
);
...
final currentUser = User(
  ...
  cart: [], // Ajoutez une liste vide pour 'card' (ou une liste d'articles si nécessaire)
);
